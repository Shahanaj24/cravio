...
const UserRegister = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        const response = await axios.post("https://cravio-btre.onrender.com/api/auth/user/register", {
        ...
        <div className="auth-page-wrapper">
            <div className="auth-card" role="region" aria-labelledby="user-register-title">
                ...
                <div className="auth-alt-action">
                    Already have an account? <Link to="/user/login">User sign in</Link>
                </div>
                <div className="auth-alt-action">
                    Food partner? <Link to="/food-partner/register">Partner registration</Link>
                </div>
            </div>
        </div>
    );
